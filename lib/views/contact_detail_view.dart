            ...
            for (final email in contact.emails!)
              ListTile(
                leading: Container(
                  ...
                  child: Icon(Icons.email, color: theme.colorScheme.secondary),
                ),
                title: Text(
                  email.value ?? '',
                  style: const TextStyle(fontSize: 16),
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Created', style: TextStyle(fontSize: 16)),
              subtitle: Text(
            ...
            ListTile(
              leading: Container(
                ...
                child: Icon(Icons.update, color: theme.colorScheme.tertiary),
              ),
              title: const Text('Last Updated', style: TextStyle(fontSize: 16)),
              subtitle: Text(
