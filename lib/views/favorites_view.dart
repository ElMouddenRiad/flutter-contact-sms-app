...
class _FavoritesViewState extends State<FavoritesView> {
    ...
    try {
      ...
      if (phone != null) {
        ...
        if (await launcher.canLaunchUrl(Uri.parse(url))) {
          ...
          if (launched) {
            await favoritesService.incrementInteractionCount(
              favorite.contactId,
              isCall: true,
            );
  ...
  Future<void> _backupFavorites() async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Backing up favorites...')));
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Failed to backup favorites: $e')));
    }
  }
  ...
  Widget _buildAvatar(Favorite favorite, ThemeData theme) {
    return Container(
      ...
      child: CircleAvatar(
        ...
        backgroundImage:
            favorite.avatar != null ? MemoryImage(favorite.avatar!) : null,
        child:
            favorite.avatar == null
                ? Text(
